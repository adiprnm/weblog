...
**[{{ blogroll.name }}]({{ blogroll.website }}){: target="_blank" class="no-text-decoration" }**<br>
...
<p>
    ...
    <strong><a href="{{ blogroll.website }}" class="no-text-decoration">{{ blogroll.name }}</a></strong><br>

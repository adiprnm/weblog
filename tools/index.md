...
* [Item Saver](/tools/item-saver){:class="underline--dotted"}: Simpan link, nomor rekening, nomor tagihan, atau apapun.
* [Random Password Generator](/tools/random-password-generator){:class="underline--dotted"}: Buat random password, simpan di password manager. <sup class="new-item"></sup>
...
* [URL Parser](/tools/url-parser){:class="underline--dotted"}: Parse URL ke dalam format yang lebih mudah dibaca.

Merasa terbantu dengan tools ini? [Support saya.](https://shop.adipurnm.com/supports)

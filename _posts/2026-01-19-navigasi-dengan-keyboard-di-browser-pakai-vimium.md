...
Percaya deh, sekali kamu udah terbiasa dengan Vim keybinding, rasanya apapun ingin dipetakan kepada Vim keybinding, termasuk navigasi di browser. Pertanyaannya, emangnya bisa???
...
Ada beberapa pemetaan yang sedikit berbeda, tapi menurut saya masih masuk akal untuk use case pengoperasian browser. Misal, `x` di Vim akan menghapus satu karakter, tapi di Vimium akan menutup tab aktif. Atau, `o` di Vim akan masuk ke mode Insert di baris baru, tapi di Vimium, akan membuka semacam URL bar seperti ini. Yaa fungsinya mirip-mirip lah dengan URL bar di browser.
...
Selain keymap, kita juga bisa bikin semacam shortcut untuk pergi ke suatu halaman tertentu. Istilahnya itu Custom search engine. Saya kurang sreg sih sama namanya, tapi ya sudahlah suka-suka creatornya aja, haha.
